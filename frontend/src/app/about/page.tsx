    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-red-950">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          {/* Keep Our Mission left-aligned */}
          <div className="flex items-center gap-4 mb-8 pl-4">
            <Flame className="h-12 w-12 text-orange-500" />
            <h1 className="text-4xl font-bold text-white">Our Mission</h1>
          </div>

          {/* Center the Story Section */}
          <div className="flex justify-center">
            <div className="bg-black/30 rounded-2xl p-8 backdrop-blur-sm border border-gray-800 shadow-xl mb-12 max-w-[90%]">
          ...
          {/* Center Additional Sections */}
          <div className="flex justify-center">
            <div className="grid md:grid-cols-2 gap-8 w-[90%]">
              <div className="bg-black/20 rounded-xl p-6 border border-gray-800">
                <h3 className="text-xl font-semibold text-orange-400 mb-4">Our Solution</h3>
              ...
              <div className="bg-black/20 rounded-xl p-6 border border-gray-800">
                <h3 className="text-xl font-semibold text-orange-400 mb-4">Our Impact</h3>
                <p className="text-gray-300">
